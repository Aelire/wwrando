...
DEFAULT_WEIGHTS = {
  ...
  "num_random_starting_items": [(0, 25), (1, 40), (2, 25), (3, 10)],
...
class SettingsRandomizer(BaseRandomizer):
  ...
  def is_enabled(self) -> bool:
    return self.options.get("randomize_settings")
  ...
  def _randomize(self):
    ...
    for option_name, option_values in DEFAULT_WEIGHTS.items():
      ...
      if option_name == "hint_placement":
        ...
        # Only set as a consequence of start_with_maps_and_compasses
        continue
    ...
    self.options.update(settings_dict)
